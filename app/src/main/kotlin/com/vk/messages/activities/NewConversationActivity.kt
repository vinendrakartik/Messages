...
import com.vk.messages.adapters.ContactsAdapter
import com.vk.messages.databinding.ActivityNewConversationBinding
import com.vk.messages.databinding.ItemSuggestedContactBinding
import com.vk.messages.extensions.getSuggestedContacts
import com.vk.messages.extensions.getThreadId
import com.vk.messages.helpers.SmsIntentParser
    ...
    private fun isThirdPartyIntent(): Boolean {
        ...
        if (result != null && (result.first.isNotEmpty() || result.second.isNotEmpty())) {
            ...
            launchThreadActivity(
                phoneNumber = URLDecoder.decode(recipients.replace("+", "%2b").trim(), StandardCharsets.UTF_8.toString()),
                name = "",
                body = body
            )
            finish()
