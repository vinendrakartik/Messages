...
abstract class SendStatusReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val SMS_SENT_ACTION = "org.fossify.com.vk.messages.receiver.SMS_SENT"
        const val SMS_DELIVERED_ACTION = "org.fossify.com.vk.messages.receiver.SMS_DELIVERED"
